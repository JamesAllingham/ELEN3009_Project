...
/**
* MovingEntity class - an extension of the Entity class which adds the move() function. This facilitates a new role - the moving entity which has the following functionality: move(), hitBoxPoints() and collide().
*/
