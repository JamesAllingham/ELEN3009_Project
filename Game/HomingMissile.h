...
private:		
	static constexpr const float _HOMING_MISSILE_WIDTH = 25.f;
	static constexpr const float _HOMING_MISSILE_HEIGHT = 25.f;	
	static constexpr const float _HOMING_MISSILE_SPEED = 200.f;
