...
/**
* ShootingMovingEntity class - an extension of the MovingEntity class which adds the shoot() function. This facilitates a new role - the shooting, moving entity which has the following functionality: shoot(), move(), hitBoxPoints() and collide().
*/
